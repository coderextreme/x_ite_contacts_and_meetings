// FIX: Add types to icon component props to fix TypeScript errors.
type IconProps = {
    className?: string;
};

const Icon = (svg: string, props: IconProps = {}) => {
...
export const UserGroupIcon = (props: IconProps) => Icon(UserGroupIconSVG, props);

const CalendarIconSVG = `<svg xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008z" /></svg>`;
export const CalendarIcon = (props: IconProps) => Icon(CalendarIconSVG, props);
...
export const ClockIcon = (props: IconProps) => Icon(ClockIconSVG, props);
...
export const BriefcaseIcon = (props: IconProps) => Icon(BriefcaseIconSVG, props);
...
export const MailIcon = (props: IconProps) => Icon(MailIconSVG, props);
...
export const PhoneIcon = (props: IconProps) => Icon(PhoneIconSVG, props);
...
export const SparklesIcon = (props: IconProps) => Icon(SparklesIconSVG, props);
...
export const PlusIcon = (props: IconProps) => Icon(PlusIconSVG, props);
...
export const PencilIcon = (props: IconProps) => Icon(PencilIconSVG, props);
...
export const TrashIcon = (props: IconProps) => Icon(TrashIconSVG, props);
...
export const XMarkIcon = (props: IconProps) => Icon(XMarkIconSVG, props);
...
export const CalendarDaysIcon = (props: IconProps) => Icon(CalendarDaysIconSVG, props);
...
export const UserPlusIcon = (props: IconProps) => Icon(UserPlusIconSVG, props);
...
export const LoadingSpinner = (props: IconProps) => Icon(LoadingSpinnerSVG, props);